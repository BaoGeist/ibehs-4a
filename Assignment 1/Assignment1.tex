...
\item Question 4
  ...
  \begin{itemize}
      \item Susceptible population: \( S(0) = 15,000 \)
      \item Infected population: \( I(0) = 250 \)
      \item Recovered population: \( R(0) = 85,000 \)
      \item Vaccinated population: \( V(0) = 0 \)
  \end{itemize}
  
  From the plot in Figure 4.1, we observe that:
  \begin{itemize}
      \item The susceptible population \( S(t) \) initially declines sharply due to the rapid spread of the infection but stabilizes around 4,000 after repeated infection cycles.
      \item The infected population \( I(t) \) experiences periodic outbreaks initially but decreases significantly after 10 years, approaching very low levels.
      \item The recovered population \( R(t) \) increases over time and stabilizes as most of the population gains immunity or recovers from the infection.
      \item The vaccinated population \( V(t) \) remains zero as no vaccination is introduced in this simulation.
  \end{itemize}
  
  The model demonstrates periodic outbreaks due to the cyclical nature of susceptible and infected individuals without vaccination.

  \begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/figure41.png}
    \caption{Plotting the susceptable, infected, recovery, vaccinated population}
    \label{fig:figure41}
  \end{figure}
  ...
  From the plot in Figure 4.2, we observe:
  \begin{itemize}
      ...
      \item After year 5, vaccination is rolled out, leading to a rapid increase in the vaccinated population \( V(t) \).
      \item The susceptible population \( S(t) \) decreases significantly after year 5 due to vaccination, reducing the number of people susceptible to the infection.
      \item The infected population \( I(t) \) drops sharply after vaccination, with outbreaks becoming less frequent and less severe.
      \item The recovered population \( R(t) \) continues to increase but stabilizes at a higher level than in 4.1.
  \end{itemize}
  
  The introduction of vaccination after year 5 effectively curtails the periodic outbreaks, leading to better control of the disease.

  \begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/figure42.png}
    \caption{Plotting infected population}
    \label{fig:figure42}
  \end{figure}
  ...
  From the plot in Figure 4.3, we observe:
  \begin{itemize}
      \item The infected population \( I(t) \) declines rapidly and effectively approaches zero within the first 10 years.
      \item The vaccination rollout significantly reduces the number of susceptible individuals, preventing further outbreaks.
      \item The recovered population \( R(t) \) stabilizes as no further infections occur.
  \end{itemize}
  
  This scenario demonstrates that achieving a critical vaccination rate leads to the eradication of the disease within a reasonable timeframe, as indicated by the absence of future outbreaks.
