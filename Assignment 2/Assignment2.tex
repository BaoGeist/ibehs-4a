...
\item Question 2
  \begin{enumerate}
    ...
    % ANSWER TO 2.5
    \item
    In this case, we analyzed the **effect of heat input \( Q(t) \) on the thermocouple temperature**. The **furnace response to \( Q(t) \) was modeled**, and the thermocouple's response was calculated using the cascaded transfer functions:
